...
export const LogoLoop = memo(
  ({
    ...
    const observerDependencies = useMemo(
    ...
    useImageLoader(seqRef, updateDimensions, observerDependencies);
    useAnimationLoop(
      trackRef,
      targetVelocity,
      seqWidth,
    ...
    const renderLogoItem = useCallback(
      (item, key) => {
        ...
        const inner = item.href ? (
          <a
            className="inline-flex items-center rounded no-underline transition-opacity duration-200 hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-current"
            href={item.href}
