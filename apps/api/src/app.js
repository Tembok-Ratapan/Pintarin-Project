...
const genAiRoutes = require('./modules/genAi/genAi.routes')
const adminDatabaseRoutes = require('./modules/adminDatabase/adminDatabase.routes')
...
app.use('/api/gen-ai', genAiRoutes)
